...
if(email == null)
{
    ...
    document.getElementById('logout-link').href = '/html/login.html';
    document.getElementById('logout-link').textContent = 'Login';
}
else {
...
document.getElementById('logout-link').href = window.location.pathname;
